...
(function(global) {
    ...
    var categoriesTitleHtml = "snippets/categories-tile-snippet.html";
    ...
    var switchMenuToActive = function() {
        ...
        var classes = document.querySelector("#nav-home-button").className;
        classes = classes.replace(new RegExp("active", "g"), "");
        document.querySelector("#nav-home-button").className = classes;

        // Add 'active' to menu button if not already there
        classes = document.querySelector("#nav-menu-button").className;
    ...
    dc.loadMenuCategories = function() {
        ...
        $ajaxUtils.sendGetRequest(
            allCategoriesUrl,
            buildAndShowCategoriesHTML); //Get JSON
    };
